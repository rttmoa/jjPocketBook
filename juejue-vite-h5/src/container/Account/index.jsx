...
// 个人中心：重置密码
  // 1、配置路由
  // 2、这里要注意，Account 在抛出去的时候，需要用 createForm() 高阶组件进行包裹，
    // 这样在 Account 的内部能接收到 form 属性，它的内部提供了 getFieldProps 方法，
    // 对 Input 组件进行表单设置，Input 的 onChange 方法会被代理，
    // 最终可以通过 form.validateFields 以回到函数的形式拿到 Input 内的值，并且可以加以验证
const Account = (props) => {
